...
export function HomePage() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "sticky top-0 z-10 mx-auto mb-6 mt-4 w-[948px] max-w-full px-6 transition-all duration-300",
          {
            "w-full bg-neutral-200 bg-opacity-70 dark:bg-neutral-800 dark:bg-opacity-70": scrolled,
          },
        )}
